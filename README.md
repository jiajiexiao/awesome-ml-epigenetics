...
- [CpG Transformer for imputation of single-cell methylomes](https://doi.org/10.1093/bioinformatics/btab746) (2021) - Transformer neural network architecture for the imputation of single-cell methylomes, achieving state-of-the-art performance on scBS-seq and scRRBS-seq datasets.
...
- [A novel computational strategy for DNA methylation imputation using mixture regression model (MRM)](https://doi.org/10.1186/s12859-020-03865-z) (2020) - Mixture regression model (MRM) for DNA methylation imputation achieving improved accuracy in recovering methylation values from RRBS data associated with bone mineral density.
...
- [BIMMER: a novel algorithm for detecting differential DNA methylation regions from MBDCap-seq data](https://doi.org/10.1186/1471-2105-15-s12-s6) (2014) - Hidden Markov Model (HMM) for differential DNA methylation region detection from MBDCap-seq data, revealing 8.83% of the breast cancer genome as differentially methylated.
...
- [A novel k-mer mixture logistic regression for methylation susceptibility modeling of CpG dinucleotides in human gene promoters](https://doi.org/10.1186/1471-2105-13-s3-s15) (2012) - k-mer mixture logistic regression model for DNA methylation susceptibility modeling of CpG dinucleotides in human gene promoters achieving AUC up to 0.75.
