...
- [scII: Dual-Threshold Adaptive Integration of Single-Cell Multiomics Data Driven by Imputation](https://doi.org/10.1021/acs.jcim.5c02396) (2026) - Multilayer perceptron with Maxout activation for dual-threshold adaptive integration of scRNA-seq and scATAC-seq data, achieving over 78% annotation accuracy and superior clustering performance.
- [scAGCI: an anchor graph-based method for cell clustering from integrated scRNA-seq and scATAC-seq data](https://doi.org/10.1093/bib/bbaf244) (2025) - Anchor graph-based clustering method scAGCI for integrated scRNA-seq and scATAC-seq data, achieving superior cell-type identification and subtype resolution.
- [Benchmarking multi-omics integration algorithms across single-cell RNA and ATAC data](https://doi.org/10.1093/bib/bbae095) (2024) - Variational auto-encoder (VAE) models for integrating single-cell RNA-seq and ATAC-seq data, achieving superior performance in omics mixing and cell type conservation metrics.
- [Integrating scRNA-seq and scATAC-seq with inter-type attention heterogeneous graph neural networks](https://doi.org/10.1093/bib/bbae711) (2024) - Heterogeneous graph neural network architecture (scMI) for integrating scRNA-seq and scATAC-seq data, achieving superior performance in modality prediction and cell clustering tasks.
- [Inference of cell type-specific gene regulatory networks on cell lineages from single cell omic datasets](https://doi.org/10.1038/s41467-023-38637-9) (2023) - Probabilistic graphical model-based multi-task learning framework (scMTNI) for inferring cell type-specific gene regulatory networks from scRNA-seq and scATAC-seq data, achieving accurate GRN dynamics identification across diverse cellular processes.
- [Single-cell multi-omics topic embedding reveals cell-type-specific and COVID-19 severity-related immune signatures](https://doi.org/10.1016/j.crmeth.2023.100563) (2023) - moETM, a product-of-experts variational autoencoder, integrates single-cell transcriptome and chromatin accessibility data to identify immune signatures related to COVID-19 severity, achieving superior performance compared to existing methods.
- [sciCAN: single-cell chromatin accessibility and gene expression data integration via cycle-consistent adversarial network](https://doi.org/10.1038/s41540-022-00245-6) (2022) - Cycle-consistent adversarial network (sciCAN) for integrating single-cell chromatin accessibility and gene expression data, achieving superior performance in modality mixing and label transferring across multiple datasets.
- [Machine Intelligence in Single-Cell Data Analysis: Advances and New Challenges](https://doi.org/10.3389/fgene.2021.655536) (2021) - MAESTRO for integrative analyses of scRNA-seq and scATAC-seq data achieving improved integration performance across datasets.
