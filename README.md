...
- [DNA methylation profiling predicts postsurgical regrowth in SF1-lineage nonfunctioning pituitary neuroendocrine tumors.](https://doi.org/10.1093/neuonc/noaf269) (2026) - Random forest classifier for DNA methylation profiling of SF1-lineage nonfunctioning pituitary neuroendocrine tumors achieving 97.5% accuracy in predicting tumor regrowth.
...
- [scCCVGBen for benchmarking of single-cell representation learning anchored on a centroid-coupled variational graph attention autoencoder across scRNA-seq and scATAC-seq](https://doi.org/10.3389/fgene.2026.1822168) (2026) - Centroid-coupled variational graph attention autoencoder for benchmarking single-cell chromatin accessibility profiling, achieving significant improvements in clustering compactness and intrinsic geometry.
...
- [DeepFRAG: a method for cancer detection based on DNA fragmentomics and deep learning.](https://doi.org/10.1038/s41591-020-0915-3) (2026) - DeepFRAG, a deep learning model utilizing genome-wide mutational integration for ultra-sensitive ctDNA detection in liquid biopsies, achieving sensitivity as low as 10^-5.
- [Early detection of multiple cancers: the era of methylation-based liquid biopsy](https://doi.org/10.3389/fonc.2026.1850041) (2026) - AI algorithms integrated with methylation-based liquid biopsy for multi-cancer early detection, addressing biological confounding and achieving significant clinical insights.
...
- [Integrative fragmentomic and mutational signature profile of plasma cfDNA for early lung cancer detection](https://doi.org/10.1038/s41698-026-01416-y) (2026) - Multi-omics model using a neural network architecture for cfDNA analysis in early lung cancer detection, achieving AUC 95.74 in validation.
...
- [Multimodal analysis of cell-free DNA to improve early detection of gastric cancer.](https://doi.org/10.1186/s13073-024-01352-1) (2026) - Ensemble model for cfDNA fragment size, copy number variation, and nucleosome coverage pattern analysis achieving AUROC of 0.962 for early-stage gastric cancer detection.
