...
- [DeepFRAG: a method for cancer detection based on DNA fragmentomics and deep learning](https://doi.org/10.1093/bioadv/vbag024) (2026) - Deep neural network (DNN) with discrete wavelet transform for cfDNA fragmentomics-based multi-type cancer detection achieving median AUROC of 0.974.
...
- [Multimodal analysis of cell-free DNA to improve early detection of gastric cancer.](https://doi.org/10.1186/s13073-024-01352-1) (2026) - Ensemble model for cfDNA fragmentomics-based early detection of gastric cancer achieving AUROC of 0.962.
...
- [Artificial intelligence and machine learning in cell-free-DNA-based diagnostics](https://doi.org/10.1101/gr.278413.123) (2025) - Random Forest and Deep Neural Networks for cfDNA-based cancer detection and localization, leveraging fragmentation patterns to achieve high diagnostic accuracy.
- [Cell-free DNA methylation and fragmentomics-based liquid biopsy for accurate esophageal cancer detection](https://doi.org/10.1186/s12885-025-15150-4) (2025) - Random forest model for cfDNA methylation and fragmentomics-based esophageal cancer detection achieving sensitivity of 99% and specificity of 97.82%.
- [Early detection of renal cell carcinoma: a novel cell-free DNA fragmentomics-based liquid biopsy assay](https://doi.org/10.1016/j.esmoop.2025.105323) (2025) - Stacked ensemble model for cfDNA fragmentomics-based renal cell carcinoma detection achieving AUC 0.966.
...
- [Detection and characterization of pancreatic and biliary tract cancers using cell-free DNA fragmentomics](https://doi.org/10.1186/s13046-024-03067-y) (2024) - Stacked machine learning model for cfDNA fragmentomics-based biliopancreatic cancer detection achieving AUC 0.995.
...
- [Advances in methylation analysis of liquid biopsy in early cancer detection of colorectal and lung cancer](https://doi.org/10.1038/s41598-023-40611-w) (2023) - Deep neural network (DNN) model for methylation-sensitive cfDNA analysis in liquid biopsy, achieving AUCs of 0.978 for colorectal cancer and 0.956 for lung cancer.
...
- [A framework for clinical cancer subtyping from nucleosome profiling of cell-free DNA](https://doi.org/10.1038/s41467-022-35076-w) (2022) - Griffin framework utilizing a GC bias correction model for nucleosome profiling from cfDNA to predict estrogen receptor subtypes in metastatic breast cancer, achieving AUC 0.96.
...
- [Fragmentation patterns and personalized sequencing of cell‐free DNA in urine and plasma of glioma patients](https://doi.org/10.15252/emmm.202012881) (2021) - Random forest classifier for cfDNA fragmentomics-based glioma detection achieving AUC 0.80–0.91.
- [Genome-wide cell-free DNA methylation analyses improve accuracy of non-invasive diagnostic imaging for early-stage breast cancer](https://doi.org/10.1186/s12943-021-01330-w) (2021) - Whole-genome bisulfite sequencing analysis for cfDNA methylation-based early-stage breast cancer detection, achieving AUC improvements from 0.78–0.79 to 0.93–0.94.
- [Prognostic Significance of Blood-Based Multi-cancer Detection in Plasma Cell-Free DNA](https://doi.org/10.1158/1078-0432.ccr-21-0417) (2021) - Random forest classifiers for cfDNA methylation-based multi-cancer detection achieving significant prognostic insights, with cancers not detected by the MCED test showing better overall survival (P < 0.0001).
