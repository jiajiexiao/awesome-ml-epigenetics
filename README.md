...
- [CpG Transformer for imputation of single-cell methylomes](https://doi.org/10.1093/bioinformatics/btab746) (2021) - Transformer neural network architecture (CpG Transformer) for the imputation of single-cell methylomes, achieving state-of-the-art performance on scBS-seq and scRRBS-seq datasets.
...
- [HOME: a histogram based machine learning approach for effective identification of differentially methylated regions.](https://doi.org/10.1186/s12859-019-2845-y) (2019) - Support Vector Machine-based Histogram Of MEthylation (HOME) for accurate identification of differentially methylated regions, outperforming existing methods in both simulated and biological datasets.
- [New insights into DNA methylation signatures: SMARCA2 variants in Nicolaides-Baraitser syndrome](https://doi.org/10.1186/s12920-019-0555-y) (2019) - Random forest classifier for DNA methylation signature-based classification of SMARCA2 variants in Nicolaides-Baraitser syndrome achieving 100% sensitivity and specificity.
- [Shared and Unique Patterns of DNA Methylation in Systemic Lupus Erythematosus and Primary Sjögren's Syndrome](https://doi.org/10.3389/fimmu.2019.01686) (2019) - Random forest classifier for predicting disease status based on DNA methylation profiles in systemic lupus erythematosus and primary Sjögren's syndrome, achieving AUC between 0.83 and 0.96.
- [BoostMe accurately predicts DNA methylation values in whole-genome bisulfite sequencing of multiple human tissues](https://doi.org/10.1186/s12864-018-4766-y) (2018) - XGBoost-based imputation method for low-quality DNA methylation values in whole-genome bisulfite sequencing, achieving improved concordance with MethylationEPIC array data.
- [DNA Methylation Signatures Predicting Bevacizumab Efficacy in Metastatic Breast Cancer](https://doi.org/10.7150/thno.23544) (2018) - Targeted deep amplicon bisulfite sequencing for DNA methylation analysis, achieving AUC 0.94 in predicting bevacizumab efficacy in metastatic breast cancer.
...
- [De novo identification of differentially methylated regions in the human genome](https://doi.org/10.1186/1756-8935-8-6) (2015) - Gaussian kernel smoothing method for identifying differentially methylated regions in DNA methylation data, outperforming existing methods with superior predictive performance.
- [Identification and analysis of methylation call differences between bisulfite microarray and bisulfite sequencing data with statistical learning techniques](https://doi.org/10.1186/1471-2105-16-s3-a7) (2015) - Support vector regression with hybrid string kernels for predicting methylation differences between bisulfite sequencing and Infinium 450K microarray data, achieving significant correlation (r = 0.37).
- [BIMMER: a novel algorithm for detecting differential DNA methylation regions from MBDCap-seq data](https://doi.org/10.1186/1471-2105-15-s12-s6) (2014) - Hidden Markov Model (HMM) for differential DNA methylation region detection from MBDCap-seq data, achieving identification of 8.83% of the breast cancer genome as differentially methylated.
...
- [Estimating absolute methylation levels at single-CpG resolution from methylation enrichment and restriction enzyme sequencing methods](https://doi.org/10.1101/gr.152231.112) (2013) - Conditional random fields model for predicting single-CpG methylation levels from MeDIP-seq and MRE-seq data, achieving results comparable to whole-genome bisulfite sequencing.
